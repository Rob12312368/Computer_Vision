...
def challenge1a():
    ...
    src_pts_nx2 = np.array([[162.0, 100.0],
                            [644.0, 98.0],
                            [640.0, 698.0],
                            [162.0, 698.0]])
    
    dest_pts_nx2 = np.array([[140.0, 144.0],
                            [620.0, 28.0],
                            [664.0, 770.0],
                            [116.0, 592.0]])
    ...
    #print(src_pts_nx2, dest_pts_nx2)
    ...
    test_pts_nx2 = np.array([[160.0, 102.0],
                            [348.0, 310.0],
                            [390.0, 572.0],
                            [590.0, 506.0]])
...
def challenge1b(): 
    from helpers import ImageClicker
    from hw4_challenge1 import computeHomography, backwardWarpImg, applyHomography
    ...
    #print('testing')
    #print(applyHomography(np.linalg.inv(H_3x3), bg_pts))
    #print('testing')
